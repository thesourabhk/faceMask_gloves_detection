...
model.save('mymodel_demo.h5', model_saved)

# To test for individual images

mymodel = load_model('mymodel_demo.h5')
test_image = image.load_img(r'/home/sourabh/data/ml/FaceMaskDetector/test/with_mask/1-with-mask.jpg',
